...
# list comprehension of a list of all of the full_names in lowercase format
lowercase_full_names = [name.lower() for name in full_names]
print(lowercase_full_names)

almost_numbers = ['0', '10', '21', '3', '-7', '88', '9']
# list comprehension of a list of integers from the above list of strings
numbers = [int(number) for number in almost_numbers]
print(numbers)

# list comprehension of a list of only the numbers that are greater than 9
